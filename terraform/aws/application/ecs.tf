  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "BTC_PRODUCTION_NETWORK_MODE", value = var.btc_production_network_mode },
        { name = "BTC_PAYOUT_RETRY_MAX_ATTEMPTS", value = var.btc_payout_retry_max_attempts },
        { name = "BTC_PAYOUT_RETRY_POLL_MS", value = var.btc_payout_retry_poll_ms },
