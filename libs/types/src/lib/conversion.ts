...
export const VALID_STATE_TRANSITIONS: Record<ConversionState, ConversionState[]> = {
  ...
  [ConversionState.IDENTITY_PENDING]: [ConversionState.COMPLIANCE_PENDING, ConversionState.FAILED],
  [ConversionState.COMPLIANCE_PENDING]: [ConversionState.PAYOUT_DETAILS_PENDING, ConversionState.FAILED, ConversionState.MANUAL_REVIEW],
  [ConversionState.PAYOUT_DETAILS_PENDING]: [ConversionState.PAYMENT_PENDING, ConversionState.FAILED],
